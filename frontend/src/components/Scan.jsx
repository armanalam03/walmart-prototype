...
export default function Scan() {
  const [itemInfo, setItemInfo] = useState({ text: "Scan to get product info and offers." });
      ...
      <div className="items_info_container">
        ...
        {itemInfo.title ? (
          <div className="product_info">
            <div className="info info_title">{itemInfo.title}</div>
            <div className="info info_price">${itemInfo.price}</div>
            <div className="info info_description">Description :<br /> {itemInfo.description}</div>
            <div className="info info_category">Category : {itemInfo.category}</div>
            <img src={itemInfo.image} className="info_image" />
            <div className="info info_rating">Rating : {itemInfo.rating.rate}</div>
          </div>
        ) : (
